-- 025: Zelle payments may leave the transaction id blank (there is no visible
-- id to paste). The 10-minute double-click guard keys on user+scope+amount with
-- a null-safe txid compare. Other methods still require an id.
